...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError('Credenciales incorrectas. Prueba con cualquier email/contraseña.');
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="relative z-10 flex flex-col justify-center px-12">
          ...
          >
            ...
            <p className="text-white/50 text-lg mb-10 leading-relaxed">
              Tu entrenador IA te ha preparado la sesión de hoy. ¡Es hora de ponerse en marcha!
            </p>
            <div className="space-y-4">
              {[
                { emoji: '🔥', text: 'Tu racha sigue activa', sub: '¡No la pierdas!' },
                { emoji: '⚡', text: 'Nuevo entrenamiento listo', sub: 'Generado por IA según tu progreso' },
                { emoji: '🏆', text: '3 logros por desbloquear', sub: 'Estás muy cerca' },
              ].map((item) => (
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        ...
        >
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              <div className="flex justify-between">
                ...
                <a href="#" className="text-xs text-[#6c5ce7] hover:underline">¿Olvidaste tu contraseña?</a>
              </div>
              <div className="relative">
          ...
          <p className="text-center text-white/30 text-xs mt-8">
            Al continuar, aceptas nuestros <a href="#" className="text-white/50 hover:text-white">Términos de uso</a> y <a href="#" className="text-white/50 hover:text-white">Política de privacidad</a>
          </p>
        </motion.div>
      </div>
    </div>
